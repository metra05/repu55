  ...
  //menampilkan jam alarm ke 2
    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        var alrmaray=this.responseText;
        var myarray= alrmaray.split(" ");
        document.getElementById("alarma").innerHTML = myarray[0] + " : "+myarray[1] + " Selama: " + myarray[2] + ", int:" + myarray[4];//this.responseText;
        document.getElementById("alarmjam1").value = myarray[0];
        document.getElementById("alarmmenit1").value = myarray[1];
        document.getElementById("alarmdetik1").value = myarray[2];
        if (myarray[3]==1){ 
        ...
        document.getElementById("sembunyi1").value = myarray[4];
      }
    };
  ...
  //menampilkan setingan hari-hari (alarm2)
    ...
    function kirimAH(){
      ...
      var integer1 = parseInt(binn1.join(""),2); 
      ...
      x.value=integer;
      let x1 = document.getElementById("sembunyi1");
      x1.value=integer1;
